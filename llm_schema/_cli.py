"""Command-line interface for llm-schema utilities.

This module provides the ``llm-schema`` entry-point command.  It is excluded
...
Entry-point (configured in pyproject.toml)::
    ...
    llm-schema = "llm_schema._cli:main"

Sub-commands
------------
``llm-schema check-compat <events.json>``
...
def main(argv: list[str] | None = None) -> NoReturn:
    """Entry point for the ``llm-schema`` CLI tool."""
    parser = argparse.ArgumentParser(
        prog="llm-schema",
        description="llm-schema command-line utilities",
    )
